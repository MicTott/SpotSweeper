# Contributing to SpotSweeper

This outlines how to propose a change to SpotSweeper. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("MicTott/SpotSweeper", fork = TRUE)`.
...
Please note that the SpotSweeper project is released with a [Contributor
Code of
Conduct](https://mictott.github.io/SpotSweeper/CODE_OF_CONDUCT.md). By
