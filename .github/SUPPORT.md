...
Thank you for using `SpotSweeper`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/SpotSweeper`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/SpotSweeper),
...
[search issues and pull requests](https://github.com/MicTott/SpotSweeper/issues)
